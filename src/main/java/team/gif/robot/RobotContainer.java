...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("MoveModulesIn", new RepeatCommand(new InstantCommand(Robot.swerveDrive::modulesTo90)));
        NamedCommands.registerCommand("AutoDriveAndShoot", new AutoDriveAndShoot(false));
