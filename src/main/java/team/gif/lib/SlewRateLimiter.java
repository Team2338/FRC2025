...
/**
 * A custom modification to the {@link edu.wpi.first.math.filter.SlewRateLimiter} class to
 * allow for separate acceleration and deceleration limits as well as setting the limits
 * on the fly.
 * <br /> <br />
 *
...
public class SlewRateLimiter {
     ...
     * @param rateLimit The rate-of-change limit, in units per second.
     */
    public void setRateLimits(double rateLimit) {
